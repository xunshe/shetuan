...
<!--  
  ...
  if(flag=='ok')
  {
    var userPhoto= window.parent.document.getElementById("paramsPicnews.picnews_picture");
    ...
    window.parent.document.getElementById("userImg").src="../images/hdtp/"+filename;
  }
  else if(flag=='no')
  {
    window.parent.document.getElementById("op").style.display="none";
